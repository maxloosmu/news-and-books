...
function wp_admin_bar_my_account_item( $wp_admin_bar ) {
	...
	$alt_text = esc_attr( sprintf( __( 'Default profile picture of %s' ), $current_user->display_name ) ); // Define alt text
	$avatar = get_avatar( $user_id, 26, '', $alt_text ); // Pass alt text as the fourth parameter
...
function wp_admin_bar_my_account_menu( $wp_admin_bar ) {
	...
	$alt_text = esc_attr( sprintf( __( 'Default profile picture of %s' ), $current_user->display_name ) ); // Define alt text
	$user_info  = get_avatar( $user_id, 64, '', $alt_text ); // Pass alt text as the fourth parameter
